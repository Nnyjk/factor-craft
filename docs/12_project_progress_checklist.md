...
- [ ] 材料等级模型（Lv1~Lv5）与基础属性（导因率、韧性、槽位等）。
- [ ] 词条池：通用词条 + 维度词条 + 终局词条。
- [ ] 附魔池：武器/工具/防具三类。
- [ ] BUFF/DEBUFF 状态池与叠加规则。
- [ ] 与 Tier 日切联动（状态池结算、装备词条修正）。
- [ ] 数值配置数据化（JSON）与校验。

**M2 验收标准**
- [ ] 材料与词条生成可复现（相同 seed/规则下结果一致）。
- [ ] 状态效果具备明确来源、持续时间与数值展示。
- [ ] 至少 1 条完整“材料 -> 词条 -> 附魔 -> 状态联动”演示链路可运行。
